...
# Step 14: Fine tuning and experimentation
...
# 14.1 Tuning Ridge Regression (alpha = 0)
...
# 14.2 Tuning Lasso Regression (alpha = 1)
...
# 14.3 Tuning Elastic Net (alpha between 0 and 1)
...
for (alpha in alpha_values) {
  ...
  elasticnet_mse <- mean((y_test - elasticnet_predictions)^2)
